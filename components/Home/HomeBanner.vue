<template>
    <section class="relative py-64 bg-violet-500">
                                                ...
                                                <div class="grid grid-cols-12">
                                                    <div class="col-span-12 xl:col-span-3">
                                                        <div class="mt-3 rounded-l filter-search-form filter-border mt-md-0">
                                                            ...
                                                            <input type="search" id="job-title" class="w-full filter-input-box placeholder:text-gray-400 placeholder:text-13 dark:text-gray-100 ps-12" placeholder="Job, Company name...">
                                                        </div>
                                                    </div><!--end col-->
                                                    <div class="col-span-12 xl:col-span-3">
